$(function() {
    ...
    calendar.fullCalendar({
        ...
        eventClick: function(calEvent, jsEvent, view) {
            ...
            let year = new Date(calEvent.start).getFullYear();
            let month = new Date(calEvent.start).getMonth() + 1;
            let day = new Date(calEvent.start).getDate() + 1;
            ...
            eventModal.find('input[name="event-date"]').val(year + '-' + month + '-' + day);

            $('#url_redirect').attr("href", calEvent.url_redirect);
