                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="em_wrapper">
                              <tr>
                                <td align="left" class="em_align_cent" style="text-align:center;font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:18px; color:#848789; text-decoration:none;">
                                  Correo generado y enviado por Lawsoft.com
                                </td>
                              </tr>
                            </table>
                          </td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; line-height:22px; color:#000">
                        <p>
                            Hola <b>{{ $nombre }}</b>,</p><p><br></p><p>Acabas de iniciar un proceso con <b>Lawsoft</b>, para ver el estado de esté, de clic en el botón de abajo; recuerde que para ver su proceso deberá digitar el siguiente código: <b>{{ $codigo }}</b>. Para cualquier inquietud comuníquese a <b>gerencia@Lawsoft.com</b>&nbsp;</p><p><br></p><p>Atentamente,&nbsp;</p><p><b>Lawsoft</b></p>
                    </td>
                  </tr>
                  <tr>
                        ...
                        <tr>
                          ...
                          <td align="center" valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                              ...
                              <tr>
                                <td   align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:20px; text-transform:uppercase; color:#cda854;"><a href="javascript:;" target="_blank" style="color:#cda854; text-decoration:none;"> PARA VER EL ESTADO DEL PROCESO </a></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="center" valign="top" >
                                  <table width="400" border="0" cellspacing="0" cellpadding="0" align="center" class="em_wrapper" style="max-width:200px;">
                                    <tr>
                                      <td  width="9">&nbsp;</td>
                                      <td  width="45" bgcolor="#cda854" height="45" align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff;"><a href="http://Lawsoft.com/procesos/ver/<?php echo $proceso_id; ?>" target="_blank" style="color:#ffffff; text-decoration:none;"> CLIC AQUÍ</a></td>
                                      <td  width="10">&nbsp;</td>
                                    </tr>
                                  </table>
                                </td>
