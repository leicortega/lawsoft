                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; line-height:22px; color:#000">
                        <p>
                            Hola <b>{{ $nombre }}</b>,</p><p><br></p><p>Acabas de iniciar un proceso con <b>ObConsultores</b>, para ver el estado de esté, de clic en el botón de abajo; recuerde que para ver su proceso deberá digitar el siguiente código: <b>{{ $codigo }}</b>. Para cualquier inquietud comuníquese a <b>gerencia@obconsultores.com</b>&nbsp;</p><p><br></p><p>Atentamente,&nbsp;</p><p><b>ObConsultores</b></p>
                    </td>
                  </tr>
                  <tr>
                              ...
                              <tr>
                                <td align="center" valign="top" >
                                  <table width="400" border="0" cellspacing="0" cellpadding="0" align="center" class="em_wrapper" style="max-width:200px;">
                                    <tr>
                                      <td  width="9">&nbsp;</td>
                                      <td  width="45" bgcolor="#cda854" height="45" align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff;"><a href="http://obconsultores.com/procesos/ver/<?php echo $proceso_id; ?>" target="_blank" style="color:#ffffff; text-decoration:none;"> CLIC AQUÍ</a></td>
                                      <td  width="10">&nbsp;</td>
                                    </tr>
                                  </table>
                                </td>
