            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td  align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:20px; text-transform:uppercase; color:#cda854;">GRACIAS POR PONERSE EN CONTACTO CON NOSOTROS</td>
                  </tr>
                  <tr>
                        ...
                        <tr>
                          ...
                          <td align="center" valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                              ...
                              <tr>
                                <td   align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:20px; text-transform:uppercase; color:#cda854;"><a href="#" target="_blank" style="color:#cda854; text-decoration:none;"> PARA RESPONDER A ESTE CORREO</a></td>
                              </tr>
                              <tr>
